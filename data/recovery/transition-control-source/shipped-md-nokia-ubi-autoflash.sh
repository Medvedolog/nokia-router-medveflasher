...
publish() {
    ...
    { echo MEDVEFLASHER_TRANSITION_PROTOCOL=1; echo MODE=TRANSITION; echo FAMILY=MD; echo BOARD=nokia,xg-040g-md-ubi; echo STATE="$1"; echo SAFE_TO_POWER_CYCLE="$safe"; } > "$STATUS.tmp"
